...
import { Plus, ChevronRight, Edit, ArrowRightLeft } from "lucide-react";
    ...
    <div className="space-y-8 py-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <Link href="/routines">
            <Button variant="outline" size="lg">
              <ArrowRightLeft /> Change Routine
            </Button>
          </Link>
          <Link href={`/edit-template/${activeRoutine?.id}`}>
            <Button variant="outline" size="lg">
              <Edit /> Edit
            </Button>
          </Link>
